...
-- AddForeignKey
ALTER TABLE "build_components" ADD CONSTRAINT "build_components_builderId_fkey" FOREIGN KEY ("builderId") REFERENCES "builders"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
